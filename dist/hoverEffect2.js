async function getFakeData() {
    ...
    console.log(jewleries);
    let JewelleryoptionsContainer = document.getElementById("JewelleryoptionsContainer");
    jewleries.map(product => {
        let a=document.createElement("a");
        a.innerHTML = `
      ...
      `;
      JewelleryoptionsContainer.append(a);
    });

  
    console.log("========== electronics ===========");
    console.log(electronics);
    let ElectronicoptionsContainer = document.getElementById("ElectronicoptionsContainer");
    electronics.map(product => {
      ...
      `;
      ElectronicoptionsContainer.append(a);
    });
